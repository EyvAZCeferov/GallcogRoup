                    ...
                    <div class="page dark">
                        <div class="page__content">
                            <div class="col-row">
                                <div class="col-7 md-auto">
                                    <div class="content text-center">
                                        ...
                                        <img src="{{ env('APP_ADMIN_URL') . '/uploads/' . 'settings/' . $data[0]->logo }}"
                                            ...
                                            class="content--logo" style="margin-bottom:-1rem">
                                ...
                                <div class="col-9 md-auto text-center" >
                                ...
                                <div class="footer__lang">
                                    ...
                                    @elseif(app()->getLocale() == 'en')
                                        <a href="{{ LaravelLocalization::getLocalizedURL('az', null, [], true) }}"
                                            class="footer__lang--link">Azərbaycan</a>
                                    @endif
                                </div>
                                <div class="footer__next">
                                    <a href="#{{ $data[1]->slugs[app()->getLocale() . '_slug'] }}"
                                        ...
                                        <span>@lang('additional.discover')</span>
                                    </a>
                                </div>
                                    ...
                                    <div class="col-8">
                                        <div class="content">
                                            <h2 class="content--heading">
                                                {{ $data[$i]->title[app()->getLocale() . '_title'] }}</h2>
                                            <div class="col-row">
                                                <div class="col-10">
                                                    <p class="content--text">
